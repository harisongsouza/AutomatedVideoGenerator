...
def create_vertical_video_with_subtitles(video_path: str, output_path: str):
    ...
    entrada_path = "C:/Users/souza/Downloads/VideoCreator/data/transcription_words.json"
    ...
    entrada_path_2 = "C:/Users/souza/Downloads/VideoCreator/data/final_list_render_SHORTS.json"
    ...
    for word in new_list_words:
        ...
        text_clip = mp.TextClip(
            ...
            #font='C:/Users/souza/Downloads/VideoCreator/BebasNeue-Regular.ttf', # Uma fonte ousada e comum. Tente 'Arial-Black' também.
            color='yellow',
            stroke_color='black',
            stroke_width=5
        )
