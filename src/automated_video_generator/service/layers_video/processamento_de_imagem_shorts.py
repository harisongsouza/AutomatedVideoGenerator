...
INPUT_IMAGE_DIR = "C:/Users/souza/Downloads/VideoCreator/assets/imagens"
OUTPUT_IMAGE_DIR = "C:/Users/souza/Downloads/VideoCreator/assets/imagens/imagens_processadas/shorts"
os.makedirs(OUTPUT_IMAGE_DIR, exist_ok=True)

# Carregar o classificador de rosto
if not os.path.exists(HAAR_CASCADE_PATH):
    print(f"layers short ERRO CRÍTICO: Arquivo Haar Cascade não encontrado em: {HAAR_CASCADE_PATH}")
    exit()
...
def process_and_validate_image_revised(image_path, output_dir):
    try:
        ...
        if processed_img_pil:
            ...
            json_path = "C:/Users/souza/Downloads/VideoCreator/data/add_img_path_img_interv_SHORTS.json"
...
def main():
    ...
    entrada_path = "C:/Users/souza/Downloads/VideoCreator/data/add_img_path_img_interv_SHORTS.json"
