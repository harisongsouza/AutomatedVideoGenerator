...
async def ler_roteiro_e_converter():
    arquivo_roteiro = "C:/Users/souza/Downloads/VideoCreator/data/roteiro.txt"  # Arquivo com o texto
    voz = "pt-BR-AntonioNeural"  # Escolha da voz
    rate = "-10%"  # Fala mais lenta para efeito dramático
    pitch = "-5Hz"  # Voz mais grave para terror
    arquivo_audio = "C:/Users/souza/Downloads/VideoCreator/assets/audio/narracao.wav"  # Nome do arquivo de saída
