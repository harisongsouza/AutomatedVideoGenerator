...
OUTPUT_IMAGE_DIR = "C:/Users/souza/Videos/VideoCreatorHowTo/assets/imagens/imagens_processadas"
...
def process_and_validate_image_revised(image_path, output_dir):
    try:
        ...
        if processed_img_pil:
            ...
            json_path = "C:/Users/souza/Videos/VideoCreatorHowTo/data/add_img_path_img_interv.json"
...
def main():
    ...
    pasta_destino = r"C:/Users/souza/Videos/VideoCreatorHowTo/assets/imagens/imagens_processadas"
